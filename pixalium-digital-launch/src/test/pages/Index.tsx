...
export default function Index() {
  return (
    <Layout>
      {/* SEO */}
      <title>GameRecharge Togo - Recharge Free Fire, COD, PUBG, Roblox | Diamants, CP, UC, Robux</title>
      <meta name="description" content="Plateforme n°1 au Togo pour recharger vos jeux préférés : Free Fire diamants, Call of Duty CP, PUBG UC, Roblox Robux. Recharge instantanée et sécurisée 24/7." />
