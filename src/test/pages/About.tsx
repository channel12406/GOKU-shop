    ...
    <Layout>
      <section className="py-24">
        <div className="container mx-auto px-4">
          <SectionHeading badge="À Propos" title="Qui Sommes-Nous" subtitle="GameRecharge Togo est votre plateforme de confiance pour recharger tous vos jeux mobiles préférés." />
          ...
          >
            <p className="text-muted-foreground leading-relaxed text-lg">
              ...
              à tous les gamers africains, GameRecharge Togo est basée à Lomé et dessert toute l'Afrique de l'Ouest. 
